...
export default function SessionRoom() {
  ...
  const mockSessionData = {
    ...
    date: "Dec 20, 2024",
    status: "waiting",
    meetingLink: `/session/room/${roomId}`,
  };
                  ...
                  {!sessionStarted ? (
                    ...
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center space-y-4">
                        ...
                        <Button onClick={startSession} size="lg" className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600">
                          Start Session
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center space-y-4">
                        ...
                        <div className="text-xs text-muted-foreground/70">Integration with WebRTC, Zoom, or Google Meet</div>
                      </div>
                    </div>
                  )}
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <Badge variant={sessionStarted ? "default" : "outline"}>{sessionStarted ? "Active" : "Waiting"}</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass border-glow">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <Badge variant="outline" className="text-xs">{sessionStarted ? "Online" : "Waiting"}</Badge>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Badge variant="outline" className="text-xs">{currentAccount ? "Online" : "Offline"}</Badge>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="p-3 bg-muted/20 rounded-lg border border-border">
                    <p className="text-xs text-muted-foreground break-all">{mockSessionData.meetingLink}</p>
                  </div>
                  <Button variant="outline" size="sm" onClick={copyMeetingLink} className="w-full">
                    {linkCopied ? (
                      <>
